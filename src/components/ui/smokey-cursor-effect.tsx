...
const FluidCursorEffect = () => {
  ...
  useEffect(() => {
    ...
    let gl: WebGL2RenderingContext | WebGLRenderingContext | null, ext: any;
    let pointers = [{
      id: -1,
      texcoordX: 0,
      texcoordY: 0,
    ...
    const initializeWebGL = () => {
      ...
      if (isWebGL2) {
        formatRGBA = getSupportedFormat(gl as WebGL2RenderingContext, (gl as WebGL2RenderingContext).RGBA16F, (gl as WebGL2RenderingContext).RGBA, halfFloatTexType);
    ...
    const compileShader = (type: any, source: string, keywords: string[] | null = null) => {
        if (!gl) return;
    ...
    class Material {
        ...
        programs: {[key: string]: WebGLProgram | null};
