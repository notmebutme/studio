  ...
  return (
    <div className="relative flex items-center justify-center w-full">
      ...
      <div className="relative group w-full">
        <textarea
            ref={ref}
            className={cn("bg-background/90 border-none w-full min-h-[120px] rounded-lg text-foreground px-4 py-3 text-base focus:outline-none placeholder:text-muted-foreground resize-none", className)}
            {...props}
         />
      </div>
    </div>
