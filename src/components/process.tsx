      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-4 md:gap-8 grid-cols-3 mt-12">
          {processSteps.map((step, index) => (
            <Card key={index} className="text-center bg-card/80 border-2 border-primary/10 hover:border-primary/30 transition-all duration-300 glow-shadow p-4 md:p-6 flex flex-col aspect-square justify-center rounded-2xl">
