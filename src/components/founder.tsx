            ...
            <div className="grid grid-cols-2 gap-4 md:gap-12 items-center">
              ...
              <div className="space-y-2 md:space-y-4 text-center md:text-left">
                <div className="space-y-1 md:space-y-2">
                  <h3 className="text-base sm:text-3xl font-bold font-headline text-foreground">Veer Shah</h3>
                  <p className="text-muted-foreground text-xs sm:text-lg">Founder & CEO, Intrix AI</p>
                </div>
                <blockquote className="text-[10px] sm:text-lg italic text-foreground/90 border-l-2 md:border-l-4 border-primary pl-2 md:pl-6 leading-tight">
