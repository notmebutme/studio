...
export const servicesData: Service[] = [
  {
    ...
    icon: <Bot className="h-8 w-8 md:h-12 md:w-12" />,
  ...
  },
  {
    ...
    icon: <Clapperboard className="h-8 w-8 md:h-12 md:w-12" />,
  ...
  },
  {
    ...
    icon: <MonitorSmartphone className="h-8 w-8 md:h-12 md:w-12" />,
  ...
  {
    slug: "ai-cgi-ads",
    icon: <Film className="h-8 w-8 md:h-12 md:w-12" />,
    title: "AI CGI Ads",
  ...
  {
    slug: "ai-voice-agent",
    icon: <Voicemail className="h-8 w-8 md:h-12 md:w-12" />,
